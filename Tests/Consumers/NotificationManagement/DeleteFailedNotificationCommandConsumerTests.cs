...
{
    private readonly ILogger<DeleteFailedNotificationCommandConsumer> _logger =
        Substitute.For<ILogger<DeleteFailedNotificationCommandConsumer>>();
    ...
    public async Task Consume_WhenDeleteCommandWithIdsReceived_ShouldDeleteManyAndResetStateStoreIfEmpty()
    {
        ...
        await using var provider = new ServiceCollection()
            .AddMassTransitTestHarness(x => { x.AddConsumer<DeleteFailedNotificationCommandConsumer>(); })
